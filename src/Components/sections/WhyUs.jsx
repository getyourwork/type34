...
const WhyUs = ()=>{
    return <section id="Whyus" class="features section">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="section-title">
                    <h3 class="wow zoomIn" data-wow-delay=".2s">Why choose us</h3>
                    <h2 class="wow fadeInUp" data-wow-delay=".4s">Our SES values.
                    </h2>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="single-feature wow fadeInUp" data-wow-delay=".4s">
                    ...
                    We ask a minimal fee because as an organization we always value our
                     ...
                     valuable time for serving you all for the betterment of your future.
                    </p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-12">
                <div class="single-feature wow fadeInUp" data-wow-delay=".6s">
                    ...
                    We as socially responsible human beings, will always stick to our value
                     ...
                     the Orphanages / Old age homes at the end of every month.
                    </p>
                </div>
            </div>
